...
| `doc/开发文档/PR_RULES.md` | 创建 PR、编写 PR 描述、review PR、合并前检查 | PR 标题、正文模板、验证要求、评审和合并规则 |
...
创建 PR / 编写 PR 描述 / review PR / 合并前检查：
1. doc/开发文档/PR_RULES.md
2. doc/开发文档/COMMIT_RULES.md
...
4. 提交或 PR 协作规范变更时，更新 doc/开发文档/COMMIT_RULES.md 或 doc/开发文档/PR_RULES.md，并检查本文件是否需要同步。
